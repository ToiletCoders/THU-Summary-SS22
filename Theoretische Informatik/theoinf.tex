...
\\\tab  \textlangle! DOCTYPE wurzelelement[Definition der XML-Elemente]]\textrangle
\\Jedes XML-Element wird durch einen Eintrag definiert
\\\tab \textlangle! ELEMENT elementname regAusdruck\textrangle
...
\includegraphics[width=1\textwidth]{"graphics/DEA-Zustand"}
%\includegraphics[width=0.8\textwidth]{"graphics/DEA-BSP"}
\end{document}